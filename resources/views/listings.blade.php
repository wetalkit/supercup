  ...
  <select name="distance" class="form-control">
    ...
    <div class="card" style="  border-style: solid; border-width: 2px; width: 300px; margin-top: 10px; margin-left: 10px">
        ...
        <div class="card-block">
            ...
            <p class="card-text">Motiv: {{$listing->motiv}}</p>
            <p class="card-text">Beds: {{$listing->no_bed}}</p>
            <p class="card-text">People: {{$listing->no_people}}</p>
            <p class="card-text">latitude: {{$listing->lat}}</p>
            <p class="card-text">longitude: {{$listing->lng}}</p>
            <p class="card-text">Seconds: {{$listing->distance_stadium_time}}</p>
            <p class="card-text">Meters: {{$listing->distance_stadium}}</p>
